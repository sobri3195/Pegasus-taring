...
pegasus-taring system heartbeat last
pegasus-taring logs --follow
pegasus-taring config get agents.defaults.heartbeat
pegasus-taring channels status --probe
```
...
```bash
pegasus-taring config get agents.defaults.heartbeat.activeHours
pegasus-taring config get agents.defaults.heartbeat.activeHours.timezone
pegasus-taring config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
pegasus-taring cron list
pegasus-taring logs --follow
```
