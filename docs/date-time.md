...
Pegasustaring defaults to **host-local time for transport timestamps** and **user timezone only in the system prompt**.
...
When `timeFormat: "auto"`, Pegasustaring inspects the OS preference (macOS/Windows)
