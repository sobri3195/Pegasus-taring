---
summary: "Use NVIDIA's OpenAI-compatible API in Pegasustaring"
read_when:
  - You want to use NVIDIA models in Pegasustaring
...
pegasus-taring onboard --auth-choice skip
pegasus-taring models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
