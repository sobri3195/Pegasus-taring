---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Pegasustaring"
read_when:
  - You want Xiaomi MiMo models in Pegasustaring
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Pegasustaring uses
...
```bash
pegasus-taring onboard --auth-choice xiaomi-api-key
# or non-interactive
pegasus-taring onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
