---
summary: "Use Qianfan's unified API to access many models in Pegasustaring"
read_when:
...
3. Pegasustaring installed on your system
...
4. Copy the API key for use with Pegasustaring

## CLI setup

```bash
pegasus-taring onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Pegasustaring Configuration](/gateway/configuration)
