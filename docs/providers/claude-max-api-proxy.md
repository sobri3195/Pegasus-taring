...
You can point Pegasustaring at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Pegasustaring
...
- [Anthropic provider](/providers/anthropic) - Native Pegasustaring integration with Claude setup-token or API keys
