...
It is modeled after Claude Code's `/btw` behavior, but adapted to Pegasustaring's
...
If the main run is currently active, Pegasustaring snapshots the current message
