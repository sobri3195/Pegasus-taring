...
read_when:
  - You want to place an outbound voice call from Pegasustaring
...
Voice calls for Pegasustaring via a plugin. Supports outbound notifications and
...
- Use `pegasus-taring voicecall ...` or the `voice_call` tool
...
```bash
pegasus-taring plugins install ./extensions/voice-call
...
```bash
pegasus-taring voicecall call --to "+15555550123" --message "Hello from Pegasustaring"
pegasus-taring voicecall continue --call-id <id> --message "Any questions?"
pegasus-taring voicecall speak --call-id <id> --message "One moment"
pegasus-taring voicecall end --call-id <id>
pegasus-taring voicecall status --call-id <id>
pegasus-taring voicecall tail
