...
Pegasustaring treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.pegasus-taring/settings/voicewake.json`

Shape:

```json
{ "triggers": ["pegasus-taring", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
