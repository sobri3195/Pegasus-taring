...
- Install via CLI: `pegasus-taring plugins install @pegasus-taring/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `pegasus-taring plugins install ./extensions/zalo`
   - From npm (if published): `pegasus-taring plugins install @pegasus-taring/zalo`
...
This page reflects current Pegasustaring behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `pegasus-taring pairing list zalo`
  - `pegasus-taring pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in Pegasustaring.
...
- Example: `pegasus-taring message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `pegasus-taring channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `pegasus-taring logs --follow`
