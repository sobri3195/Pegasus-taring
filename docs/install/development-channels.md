...
Pegasustaring ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Pegasustaring also aligns
the install method:
...
When you switch channels with `pegasus-taring update`, Pegasustaring also syncs plugin sources:
