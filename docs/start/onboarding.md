---
summary: "First-run setup flow for Pegasustaring (macOS app)"
read_when:
...
- By default, Pegasustaring is a personal agent: one trusted operator boundary.
...
<Frame caption="Choose what permissions do you want to give Pegasustaring">
...
<Step title="CLI">
  ...
  The app can install the global `pegasus-taring` CLI via npm/pnpm so terminal
