---
summary: "Hubs that link to every Pegasustaring doc"
read_when:
...
<Note>
If you are new to Pegasustaring, start with [Getting Started](/start/getting-started).
</Note>
...
- [Pegasustaring assistant](/start/pegasus-taring)
