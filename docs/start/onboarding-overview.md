---
summary: "Overview of Pegasustaring onboarding options and flows"
read_when:
...
Pegasustaring supports multiple onboarding paths depending on where the Gateway runs
...
- [`pegasus-taring onboard` command](/cli/onboard)

## macOS app onboarding

Use the Pegasustaring app when you want a fully guided setup on macOS. Docs:
