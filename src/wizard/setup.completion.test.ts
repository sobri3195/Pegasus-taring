...
describe("setupWizardShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("pegasus-taring");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "pegasus-taring");
