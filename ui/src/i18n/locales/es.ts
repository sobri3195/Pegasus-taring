...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.pegasus-taring/pegasus-taring.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde pegasus-taring dashboard --no-open en tu escritorio.",
    },
    insecure: {
