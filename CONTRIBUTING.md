# Contributing to Pegasustaring

Welcome to the lobster tank! 🦞

## Quick Links

- **GitHub:** https://github.com/pegasus-taring/pegasus-taring
- **Vision:** [`VISION.md`](VISION.md)
- **Discord:** https://discord.gg/qkhbAGHRBT
- **X/Twitter:** [@steipete](https://x.com/steipete) / [@pegasus-taring](https://x.com/pegasus-taring)
...
2. **New features / architecture** → Start a [GitHub Discussion](https://github.com/pegasus-taring/pegasus-taring/discussions) or ask in Discord first
...
- Test locally with your Pegasustaring instance
...
- **Skills**: For skill contributions, head to [ClawHub](https://clawhub.ai/) — the community hub for Pegasustaring skills.
- **Performance**: Optimizing token usage and compaction logic.

Check the [GitHub Issues](https://github.com/pegasus-taring/pegasus-taring/issues) for "good first issue" labels!

## Maintainers

We're selectively expanding the maintainer team.
If you're an experienced contributor who wants to help shape Pegasustaring's direction — whether through code, docs, or community — we'd like to hear from you.

Being a maintainer is a responsibility, not an honorary title. We expect active, consistent involvement — triaging issues, reviewing PRs, and helping move the project forward.

Still interested? Email contributing@pegasus-taring.ai with:

- Links to your PRs on Pegasustaring (if you don't have any, start there first)
...
- **Core CLI and gateway** — [pegasus-taring/pegasus-taring](https://github.com/pegasus-taring/pegasus-taring)
- **macOS desktop app** — [pegasus-taring/pegasus-taring](https://github.com/pegasus-taring/pegasus-taring) (apps/macos)
- **iOS app** — [pegasus-taring/pegasus-taring](https://github.com/pegasus-taring/pegasus-taring) (apps/ios)
- **Android app** — [pegasus-taring/pegasus-taring](https://github.com/pegasus-taring/pegasus-taring) (apps/android)
- **ClawHub** — [pegasus-taring/clawhub](https://github.com/pegasus-taring/clawhub)
- **Trust and threat model** — [pegasus-taring/trust](https://github.com/pegasus-taring/trust)

For issues that don't fit a specific repo, or if you're unsure, email **security@pegasus-taring.ai** and we'll route it.
